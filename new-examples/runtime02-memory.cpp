...
int main(int argc, const char **argv) {
    ...
    // Verify the element size of the memory objects
    std::cout << "Size of o_a: " << o_a.length() << " elements\n";
    std::cout << "Size of o_b: " << o_b.length() << " elements\n";
    std::cout << "Size of casted_o_b: " << casted_o_b.length() << " elements\n";
...
//todo include memory slicing here or in a different one? 
