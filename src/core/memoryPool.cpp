...
namespace occa
{
  memoryPool::memoryPool() : modeMemoryPool(NULL) {}

  memoryPool::memoryPool(modeMemoryPool_t *modeMemoryPool_) : modeMemoryPool(NULL)
  {
    setModeMemoryPool(modeMemoryPool_);
  }

  memoryPool::memoryPool(const memoryPool &m) : modeMemoryPool(NULL)
  {
  ...
  {
    return 0; 
    // return modeMemoryPool->freeDeviceMemory(); // todo
  }
